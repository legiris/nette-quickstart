<?php //netteCache[01]000406a:2:{s:4:"time";s:21:"0.11348400 1364900127";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:84:"/var/www/test.lamp/web/nette-quickstart/sandbox/app/templates/Homepage/default.latte";i:2;i:1364900120;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"c0332ac released on 2013-03-08";}}}?><?php

// source file: /var/www/test.lamp/web/nette-quickstart/sandbox/app/templates/Homepage/default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'vxwrohyutq')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb330352fde6_content')) { function _lb330352fde6_content($_l, $_args) { extract($_args)
?><div id="banner">
	<h1>Task manager</h1>
</div>
...
<?php $iterations = 0; foreach ($tasks as $task): ?>
				<tr>
					...
					<td><?php echo Nette\Templating\Helpers::escapeHtml((substr($task->user->name, 0, 2) == 'Ch' ? substr($task->user->name, 0, 2) : substr($task->user->name, 0, 1)) . '. ' . $task->user->surname, ENT_NOQUOTES) ?></td>
					<td><?php echo Nette\Templating\Helpers::escapeHtml($template->date($task->created, 'Y-n-j, H:i:s'), ENT_NOQUOTES) ?></td>
					<td><?php echo Nette\Templating\Helpers::escapeHtml($template->date($task->assumed, 'Y-n-j, H:i:s'), ENT_NOQUOTES) ?></td>
					<td><?php echo Nette\Templating\Helpers::escapeHtml($template->date($task->done, 'Y-n-j, H:i:s'), ENT_NOQUOTES) ?></td>
					<td></td>
				</tr>	
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lbed4c07c9a8_scripts')) { function _lbed4c07c9a8_scripts($_l, $_args) { extract($_args)
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbbf18482946_head')) { function _lbbf18482946_head($_l, $_args) { extract($_args)
?><style>
